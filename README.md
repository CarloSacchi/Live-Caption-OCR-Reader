...
- ✅ **Live text overlay feature**

---

## 📌 Features
✔ **Select a screen area** dynamically  
...
1️⃣ **Select a language** from the dropdown menu.  
2️⃣ **Click "Start (Select Area)"** to open the selection window.  
3️⃣ **Draw a rectangle** over the area you want to capture.  
4️⃣ **Press OK** to start real-time OCR.  
5️⃣ **Press `Ctrl+Q`** to stop the capture.  

📂 **Captured text is saved in a file named** `capture_YYYY-MM-DD-HH-MM-SS.txt`.
...
- 📉 **Live text overlay for subtitles and captions**
- 📉 **Dark mode UI improvement**
- 📉 **Cloud integration for OCR storage**
